...
class _BetingHistoryState extends State<BetingHistory>
  ...
  Future<List<Trans>> getTrans() async {
    ...
    final response = await http.get(
        Uri.parse(Apiconst.baseurl+"bet?id=$userid"));
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text('Loss',style: TextStyle(color:Colors.red ,fontWeight: FontWeight.w900),) ,
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text('Pending',style: TextStyle(color:Colors.orangeAccent ,fontWeight: FontWeight.w900),) ,
